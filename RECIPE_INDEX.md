# Recipe Test Kitchen Index

Add recipe links to the sections below. The generator uses this file to decide the order recipes appear in the combined book.
...
- [Sweet Potato Chips with Onion Dip](recipes/to-try/sweet-potato-chips-with-onion-dip.md)
- [Tofu & Mango Summer Rolls](recipes/to-try/tofu-and-mango-summer-rolls.md)
- [Ultimate Vegetable Soup](recipes/to-try/ultimate-vegetable-soup.md)
